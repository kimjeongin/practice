...
export class ConfigFactory {
  ...
  private static createBaseConfig(): ServerConfig {
    return {
      ...
      // 문서 처리 설정
      chunkSize: parseInt(process.env['CHUNK_SIZE'] || '600'), // 청크 크기: 800토큰
      ...
      minChunkSize: parseInt(process.env['MIN_CHUNK_SIZE'] || '400'), // 최소 청크 크기: 500토큰
      ...
      // 검색 설정
      semanticScoreThreshold: parseFloat(process.env['SEMANTIC_SCORE_THRESHOLD'] || '0.6'), // 시맨틱 임계값: 0.5
