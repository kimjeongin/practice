...
import { FileHandler } from '../../documents/processing/file-handler.js';
import { SystemHandler } from '../../search/system-handler.js';
import { ModelHandler } from '../../ai/management/model-handler.js';
...
export class MCPController {
      ...
      try {
        ...
        switch (name) {
          case 'search_documents':
            ...
            break;
          case 'list_files':
            result = await this.fileHandler.handleListFiles(args as any);
            break;
          case 'get_file_metadata':
            result = await this.fileHandler.handleGetFileMetadata(args as any);
            break;
          case 'update_file_metadata':
            result = await this.fileHandler.handleUpdateFileMetadata(args as any);
            break;
          case 'search_files_by_metadata':
            result = await this.fileHandler.handleSearchFilesByMetadata(args as any);
            break;
  ...
  async start(): Promise<void> {
    ...
    console.log('🎯 MCP Controller started and ready for stdio connections');
  }

  async shutdown(): Promise<void> {
    console.log('🔄 Shutting down MCP Controller...');
    // Add any cleanup logic here if needed
    console.log('✅ MCP Controller shutdown completed');
  }
}