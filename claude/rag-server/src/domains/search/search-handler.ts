import { RAGWorkflowService, RAGSearchOptions } from './rag-workflow-service.js';
...
export class SearchHandler {
  constructor(private ragWorkflowService: RAGWorkflowService) {}
  ...
  async handleSearchDocuments(args: SearchDocumentsArgs) {
    ...
    const results = await this.ragWorkflowService.search(query, options);
